                    ...
                    <div class="white_box mb_30">
                        <div class="box_header ">
                            <div class="main-title">
                                <h3 class="mb-0">Add Data Galeri</h3>
                            </div>
                        </div>
                        <form class="needs-validation" action ="/data-galeri" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                ...
                                <input type="text" id="exampleFormControlInput1" placeholder="Masukkan judul galeri"
                                    ...
                                    value="{{ old('judul_galeri') }}" name="judul_galeri">
                                @error('judul_galeri')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="exampleFormControlInput1" placeholder="Masukkan Deskripsi Berita"
                                    ...
                                    value="{{ old('deskripsi_galeri') }}" name="deskripsi_galeri">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" value="{{ old('gambar_galeri') }}"
                                    name="gambar_galeri" id="inputGroupFile02">
                                @error('gambar_galeri')

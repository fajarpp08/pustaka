                    ...
                    <div class="white_box mb_30">
                        <div class="box_header ">
                            <div class="main-title">
                                <h3 class="mb-0">Edit Data Berita</h3>
                            </div>
                        </div>
                        <form class="needs-validation" action ="/data-berita/{{ $beritas->id }}" method="post"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="exampleFormControlInput1" placeholder="Masukkan judul berita"
                                    ...
                                    value="{{ old('judul_berita', $beritas->judul_berita) }}" name="judul_berita">
                                @error('judul_berita')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" id="exampleFormControlInput1" placeholder="Masukkan tanggal berita"
                                    ...
                                    value="{{ old('tanggal_berita', $beritas->tanggal_berita) }}" name="tanggal_berita">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="exampleFormControlInput1" placeholder="Masukkan deskripsi berita"
                                    ...
                                    value="{{ old('deskripsi_berita', $beritas->deskripsi_berita) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control"
                                    value="{{ old('gambar_berita', $beritas->gambar_berita) }}" name="gambar_berita"
                                    id="inputGroupFile02">
                                @error('gambar_berita')

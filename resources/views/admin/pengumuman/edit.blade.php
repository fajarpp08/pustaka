                    ...
                    <div class="white_box mb_30">
                        <div class="box_header ">
                            <div class="main-title">
                                <h3 class="mb-0">Edit Data Pengumuman</h3>
                            </div>
                        </div>
                        <form class="needs-validation" action ="/data-pengumuman/{{ $pengumumans->id }}" method="post"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="exampleFormControlInput1" placeholder="Masukkan judul pengumuman"
                                    ...
                                    value="{{ old('judul_pengumuman', $pengumumans->judul_pengumuman) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" id="exampleFormControlInput1"
                                    ...
                                    value="{{ old('tanggal_pengumuman', $pengumumans->tanggal_pengumuman) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="exampleFormControlInput1"
                                    ...
                                    value="{{ old('deskripsi_pengumuman', $beritas->deskripsi_pengumuman) }}"
                            ...
                            <div class="mb-3">
                                <label class="form-label input-group mb-3" for="inputGroupFile02">Gambar Pengumuman</label>
                                <input type="file" class="form-control"
                                    value="{{ old('gambar_pengumuman', $beritas->gambar_pengumuman) }}"

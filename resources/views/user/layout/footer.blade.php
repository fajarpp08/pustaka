    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1 ms-start">
                ...
                <a class="footer__tagline" href="{{ url('tel:+6281288776655') }}">tel : <span>+6281288776655</span>
                </a>
            </div>
            {{-- end address --}}
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="footer__image-grid">
                            <img src="../assets-user/img/logo-sekolah.png" alt="Image 1" class="footer__image">
                            <img src="../assets-user/img/logo-sekolah.png" alt="Image 2" class="footer__image">
                            <img src="../assets-user/img/logo-sekolah.png" alt="Image 3" class="footer__image">
                            <img src="../assets-user/img/logo-sekolah.png" alt="Image 4" class="footer__image">
                            <img src="../assets-user/img/logo-sekolah.png" alt="Image 5" class="footer__image">
                            <img src="../assets-user/img/logo-sekolah.png" alt="Image 6" class="footer__image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="footer__content">
                    ...
                    <small class="footer__copyright">© 2024. Created by <a href="https://github.com/fajarpp08"
                            target="_blank">Rifki Mulfianda, 2101092028
                        </a>.</small>
                </div>
            </div>
        </div>
